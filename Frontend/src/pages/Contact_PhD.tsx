        ...
        <div className="min-h-screen bg-white p-12">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-gray-100 p-6 rounded-lg shadow-md mb-6">
                    ...
                    <p className="text-gray-800">Email: <a href="mailto:rpandhare@iiitn.ac.in" className="text-blue-600 underline">rpandhare@iiitn.ac.in</a></p>
                </div>
                ...
                <div className="bg-gray-100 p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-800">Email: <a href="mailto:mayuri@iiitn.ac.in" className="text-blue-600 underline">mayuri@iiitn.ac.in</a></p>
                </div>
            </div>
        </div>
    );
